...
function countDistanceLetterRecursive(sentence, letter) {
  // console.log(sentence.substring(1), '----', sentence[0], '===', letter);
  if (sentence[0] === letter) {
    return 1;
  } else {
    return 1 + countDistanceLetterRecursive(sentence.substring(1), letter); //must include letter
  }
  // console.log(sentence.substring(1))
}
