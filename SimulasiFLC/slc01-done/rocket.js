...
Contoh:
  formatDuration(62)    // "1 menit dan 2 detik"
...
function formatDuration(seconds) {
  var tahun = Math.floor(seconds / 31536000);
  var hari = Math.floor((seconds % 31536000) / 86400);
  var jam = Math.floor(((seconds % 31536000) % 86400) / 3600);
  var menit = Math.floor(((seconds % 31536000) % 86400 % 3600) / 60);
