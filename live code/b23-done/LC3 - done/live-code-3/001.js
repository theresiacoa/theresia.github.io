...
Kelompokkanlah 
hasil penjumlahan bilangan yang genap dan 
bilangan yang ganjil 
dan return array 2 dimensi di mana array pertama merupakan hasil penjumlahan angka ganjil 
dan array selanjutnya adalah hasil penjumlahan angka genap
...
function addEvenOdd (arrNum) {
  ...
  for (var i = 0; i < arrNum.length; i++) {
    if (arrNum[i] % 2 === 0) {
      ...
      hasilGanjil += arrNum[i];
    }
  }
  arr[0].push(hasilGanjil);
  arr[1].push(hasilGenap);
  return arr;
}
