...
console.log(primeNumberCruncher(10)); // [ 5, 7 ]
console.log(primeNumberCruncher(44)); // [ 23, 29, 31, 37, 41, 43 ]
console.log(primeNumberCruncher(23)); // [ 13, 17, 19, 23 ]
console.log(primeNumberCruncher(1)); // []
console.log(primeNumberCruncher(0)); // []
